...
public function index(Request $request){
   $results = DB::select( DB::raw("select api.product_id,api.product_sku,ap.product_name,ap.featured_image,ap.brand_id,ap.description,apc.product_category_name,apc.category_featured_image,
       ...
       group by api.unit_type, api.unit_amount having Max(final_discount)"), array(
         ...
         $status = DB::table("admin_product_inventary")->where('city_id',$request->city_id)
    	->get();
    	foreach($status as $value){
    	    $Recommended = DB::table("admin_product_inventary")
    	    ...
    	    ->select('admin_product_inventary.*','admin_product.product_name','admin_product.featured_image','admin_product_category.product_category_name'
    	    ,'admin_product_sub_category.product_sub_category_name',
    	    'brand_table.brand_name'
    	    )
    	    ->where('status','Recommended')->get();
    	}
    	foreach($status as $value){
    	    $hotdeal = DB::table("admin_product_inventary")
    	    ->join('admin_product','admin_product.product_sku','=','admin_product_inventary.product_sku')
    	    ->join('admin_product_category','admin_product_category.product_category_id','=','admin_product.product_category_id')
    	    ->join('admin_product_sub_category','admin_product_sub_category.product_sub_category_id','=','admin_product.product_sub_category_id')
    	     ->join('brand_table','brand_table.brand_id','=','admin_product.brand_id')
    	    ...
    	    ->where('status','Hot Deal')->get();
    	}
    	foreach($status as $value){
    	    $mustby = DB::table("admin_product_inventary")
    	    ->join('admin_product','admin_product.product_sku','=','admin_product_inventary.product_sku')
    	    ->join('admin_product_category','admin_product_category.product_category_id','=','admin_product.product_category_id')
    	    ->join('admin_product_sub_category','admin_product_sub_category.product_sub_category_id','=','admin_product.product_sub_category_id')
    	     ->join('brand_table','brand_table.brand_id','=','admin_product.brand_id')
        ...
        public function search_list_product(Request $request){
        ...
        api.mrp,
        api.inventory_id,
        api.discount_type,api.discount_amount inventory_discount_amount,availability from admin_product_inventary api 
       left join admin_product_variant apv on apv.variant_id = api.variant_id 
       left join admin_product ap on ap.product_id = api.product_id 
       left join admin_product_category apc on apc.product_category_id = ap.product_category_id 
       left join admin_product_sub_category apsc on apsc.product_sub_category_id = ap.product_sub_category_id 
    ...
    group by api.unit_type, api.unit_amount having Max(final_discount)"), array(
        ...
        $resultscat=DB::table('admin_product_category')
        ...
        foreach($resultscat as $resultcat){
            $cat =  $resultcat->product_category_id;
            ...
            if($previous_p_id != $resultcat->id){
                 $i++;
                 array_push($jsonResultcat,array(
                'product_category_id'=>$resultcat->product_category_id,
                'product_category_name'=>$resultcat->product_category_name,
                'category_image'=>$resultcat->category_featured_image,
        ...
        //  = DB::table('admin_product_category')->select('product_category_name','category_featured_image')->get();
