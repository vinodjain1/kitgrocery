<?php include '../pages/header.php' ?>
    ...
    $accountholdername='';
     ...
     $resultdata =$con->query("select * from `tbl_transcation` where vender_id='$venderid' and status='Paid' and create_at < NOW() " );
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                ...
                                                <button class="btn btn-outline-danger" onclick="paymentstatus(<?php echo $data['id'];?>,'paid')">استرجع</button>
                                                <?php } else { ?>
                                                <button class="btn btn-outline-info" onclick="paymentstatus(<?php echo $venderid;?>,'payment complete')">منجز</button>
                                                <?php } ?>
                                              </td>
                                            </tr>
                                            <?php } }?>
