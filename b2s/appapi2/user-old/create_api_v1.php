...
$insert = $con->query("INSERT INTO `tbl_order`( `user_name`, `user_email`, `user_phone`, `user_id`,`city`, `location`, `latitude`, `longitude`, `status`, `create_at`,`coupon_code`,`coupon_percent`,`pay_price`,`payment_mode`,`commission`) VALUES 
                                         ('$username','$useremail','$userphone','$userid','$city','$location','$latitude','$longitude','Yet to accept',NOW(),'$coupon_code','$coupon_percent','$pay_price','$payment_mode','$percent')");
