<?php include '../pages/header.php' ?>
     <?php
     $resultdata =$con->query("select * from `tbl_order` order by id desc" );
     $result=array();
                                         ...
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                 <a href='view.php?id=<?php echo $data['id'];?>'><button class="btn btn-outline-info">عرض</button>
                                                </a> 
