<?php include '../pages/header.php' ?>
     <?php
     $resultdata =$con->query("select * from `tbl_sub_sub_category` order by id desc" );
     $result=array();
                                        ...
                                        cellspacing="0" width="100%">
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            $tbl_sub_categoryresultdata =$con->query("select * from `tbl_sub_category` where id=$subid" );
                                             $sub_name=null;
                                             
                                             
                                             while($tbl_sub_categoryrow=mysqli_fetch_array($tbl_sub_categoryresultdata))
                                            {
                                             $sub_name=$tbl_sub_categoryrow['name_ar'] .','.$tbl_sub_categoryrow['name_en'];
                                             $mainid=$tbl_sub_categoryrow['main_category_id'];
                                             ...
                                             $tbl_main_categoryresultdata =$con->query("select * from `tbl_main_category` where id=$mainid" );
                                                ...
                                                {
                                                  $main_name=$tbl_main_categoryrow['name_ar'] .','.$tbl_main_categoryrow['name_en'];
                                                }
                                            }
