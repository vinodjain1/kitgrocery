<?php include '../pages/header.php' ?>
     <?php
     $resultdata =$con->query("select * from `users` order by id desc" );
     $result=array();
                                         ...
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo $data['loginAt'] ?></td>
                                              <td>
                                                 <!--<a href="edit.php?id=<?php echo $data['id'];?>" ><button class="btn btn-outline-primary" >Edit</button></a>-->
