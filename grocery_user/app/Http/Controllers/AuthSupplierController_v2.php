   ...
   public function signin()
{
    ...
    public function postLogin(Request $request)
    {
        ...
        $user_id = $cat_id;
        $checker = Supplier::select('phone','user_type')->where('phone',$request->phone)->where('user_type',$user_type)->exists();
        ...
        if(empty($checker)){
         ...
         $password = "test@123";
                ...
                $api_token = $password;
                $_reg = DB::insert("INSERT INTO suppliers(supplier_id,phone,password,api_token,user_type) VALUES(?,?,?,?,?)", [$user_id,$request->phone,$passpassword,$api_token,$user_type]);
                      
    //   echo"<pre>";print_r($_reg);die;
 ...
 $user_arr=array(
      ...
      print_r(json_encode($user_arr));
        ...
        $cat_id = rand(1000,1000000000);
        $user_id = $cat_id;
        $checker = Supplier::select('email','user_type')->where('email',$request->email)->where('user_type',$user_type)->exists();
